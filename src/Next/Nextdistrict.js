...
const baseUrl = \`\${process.env.NEXT_PUBLIC_BASE_URL}/Districts\`;
const countryUrl = \`\${process.env.NEXT_PUBLIC_BASE_URL}/Countries\`;
const stateUrl = \`\${process.env.NEXT_PUBLIC_BASE_URL}/States\`;`}</pre>
        </section>

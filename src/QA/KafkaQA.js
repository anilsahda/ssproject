...
Currently, my role focuses on enterprise architecture, solution design, technical leadership, cloud strategy, and guiding development teams while remaining actively involved in hands-on development and key technical decisions.</p>)
      ...
      >Architect</button>
      <button className="btn btn-primary me-2 mb-2" onClick={() =>
          handleOpenPopup(<p>My name is Amit Kumar. I have around 18 years of experience in technology professional with strong expertise in SQL Server, database development, data modeling, ETL/ELT processes, cloud platforms, and enterprise application architecture. Throughout my career, I have worked extensively with relational databases, APIs, CSV/Excel files, and various data sources to build scalable and reliable data integration solutions.<br /><br />
I have hands-on experience in designing and developing data pipelines that extract, transform, and load data into operational databases, data warehouses, and reporting systems. My expertise includes SQL query optimization, indexing, partitioning, stored procedures, CDC, incremental loading, and performance tuning of large datasets.<br /><br />
I have worked on both OLTP and OLAP systems and have implemented Star Schema and Snowflake Schema models for business intelligence and reporting solutions. I am familiar with modern data engineering concepts such as Data Lakes, Data Warehouses, Lakehouse architecture, Batch Processing, Real-Time Streaming, Kafka, and cloud-native data platforms.<br /><br />
In addition, I have experience working with AWS and Azure services, integrating data from APIs, flat files, databases, and third-party applications. I have collaborated closely with business stakeholders, analysts, architects, and development teams to deliver high-quality data solutions that support business decision-making.<br /><br />
My background as a Solution Architect gives me a broader understanding of enterprise systems, scalability, security, and architecture design. I am currently enhancing my expertise in modern data engineering technologies such as Databricks, Snowflake, PySpark, Delta Lake, and AI-driven analytics platforms to build next-generation data solutions.</p>)
        }
